        ...
        switch(event.type)
        {
            ...
            case 'touchstart':
                ...
                _mousedown = true;
       			...
       			triggerEvent("start", { originalEvent:event });
            ...
            case 'touchmove':
                ...
                triggerEvent("move", { originalEvent:event });
            ...
            case 'touchend':
                ...
                triggerEvent("end", { originalEvent:event });
 ...
 */
(function ($) {
    var hammerEvents = ['start','move','end', 'hold','tap','doubletap','transformstart','transform','transformend','dragstart','drag','dragend','swipe','release'];
